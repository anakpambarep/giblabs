...
<html lang="en">
  ...
  <head>
    ...
    <title>GibLabs - Digital Marketing Content</title>
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-7">
          <ul class="info">
            <li><a href="#"><i class="fa fa-envelope"></i>giiblabtion@gmail.com</a></li>
            <li><a href="#"><i class="fa fa-phone"></i>0857-3508-7444</a></li>
          </ul>
        </div>
        <div class="col-lg-4 col-sm-4 col-5">
          <ul class="social-media">
            <li><a href="https://www.instagram.com/giblabs/"><i class="fa fa-instagram"></i></a></li>
            <li><a href="http://wa.me/628573508744"><i class="fa fa-whatsapp"></i></a></li>
        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="assets/images/GiblabsGreen.png" alt="" style="width:170px;">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h6>Digital Marketing Content</h6>
                    <h2>We Boost Your Social Media Traffic</h2>
            ...
            <div class="col-lg-6 align-self-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
              <div class="about-right-content">
                <div class="section-heading">
                  <h6>About Us</h6>
                  <h4>Who is GibLabs <em>Agency</em></h4>
        ...
        <div class="col-lg-6 show-up wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
          <div class="blog-post">
            ...
            <div class="down-content">
              ...
              <span class="author"><img src="assets/images/author-post.jpg" alt="">By: Erdian Sahlan</span>
        ...
        <div class="col-lg-12 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="" method="post">
            <div class="row">
              ...
              <div class="col-lg-5">
                <div id="map">
                  <iframe src="https://www.google.com/maps/embed/v1/directions?origin=place_id:ChIJcSiubNyWeC4RNiqFXk7Psg0&destination=...&key=..." width="100%" height="636px" frameborder="0" style="border:0" allowfullscreen></iframe>
                </div>
              </div>
              <div class="col-lg-7">
                <div class="fill-form">
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <p>Copyright © 2022 GibLabs Co., Ltd. All Rights Reserved. 
        </div>
      </div>
    </div>
  </footer>
  ...
  <script src="<?php echo e(url('jquery/jquery.min.js')); ?>"></script>
  <script src="<?php echo e(url('boostrap/js/bootstrap.bundle.min.js')); ?>"></script>
  <script src="<?php echo e(url('assets/js/owl-carousel.js')); ?>"></script>
  <script src="<?php echo e(url('assets/js/animation.js')); ?>"></script>
  <script src="<?php echo e(url('assets/js/imagesloaded.js')); ?>"></script>
  <script src="<?php echo e(url('assets/js/custom.js')); ?>"></script>

  <!---->

</body>
</html><?php /**PATH D:\Aplication Web\giblabs\resources\views/home.blade.php ENDPATH**/ ?>